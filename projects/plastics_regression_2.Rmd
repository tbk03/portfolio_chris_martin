...
p <- waste_mismanaged_gdp_plot %>% 
  ...
  # add background colour and reference lines which emphasis three potential trends
  # dependent of gdp_per_capita
  geom_rect(aes(xmin = group_boundaries[1], xmax = group_boundaries[2], ymin = -0.05, ymax = 1.05),
  ...
  geom_point(#mapping = aes(size = plastic_waste_tot,
             ...
             alpha = 0.9, shape = 21, colour = "grey50",
  ...
  # add plot labels 
  labs(title = "Is an increase in GDP per capita associated with a reduction\nin the percentage of plastic waste a country mismanages?\n",
       x = "\nGDP per capita\n(on a log scale)",
  ...
  # annotate("text", x = 1300, y = 0.99, label = "Group 1", colour = "grey50") +
  # annotate("text", x = 10000, y = 0.99, label = "Group 2", colour = "grey50") +
  # annotate("text", x = 80000, y = 0.99, label = "Group 3", colour = "grey50") +
  annotate("text", x = 1300, y = 0.05, 
           label = "Economic development\nnot reducing\n mismanagement?", 
           colour = "grey50", size = 3) +
  annotate("text", x = 80000, y = 0.95, 
           label = "Economic development\nnot reducing\n mismanagement?", 
           colour = "grey50", size = 3) +
  
    annotate("text", x = 5700, y = 0.05, 
           label = "Economic development\nreducing\n mismanagement?", 
           colour = "grey50", size = 3) +
